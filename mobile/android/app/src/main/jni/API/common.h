...
// This enum should match the constants defined in com.androidplaygroundproject.drone.NavData class
...
// This enum should match the constants defined in com.androidplaygroundproject.service.DroneControlService
typedef enum {
	CONTROL_SET_YAW = 0,
	CONTROL_SET_GAZ,
	CONTROL_SET_PITCH,
